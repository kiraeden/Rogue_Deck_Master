...
<html>
	<head>
		...
		<title>Rogue Deck Master - Deck - </title>
	...
	<body>
		<?php
			...
			if(!empty($_GET['decknum'])) {
				...
				if(!$result){
					echo "<p>I'm sorry, this deck doesn't exist anymore.</p>";
				}
		...
		?>
		<p> You have reached this page in error. Please select the a deck list from View Decks </p>
